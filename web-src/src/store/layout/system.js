...
export const useSystemStore = defineStore(
  ...
  () => {
    ...
    // Getting raw routing information
    ...
    // Remove components of closed tabs from keep-alive
    ...
    const closeCurrentTab = route => {
      ...
      // If the closed tab is the currently active tab, redirect to the page
      if (isDelCurrentTab) {
        const currentRoute =
    ...
    watch(lockScreenCounter, () => {
      if (
        ...
        setLockScreenPassword('123456') // default password
      }
    })
